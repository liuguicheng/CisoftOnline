...
@Entity
@Table(name="n_purchasereturn")
public class PurchaseReturn extends PageRequest{
//采购退货
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	private int pr_id;
	private String pr_no;//采购订单（退货）
	private String pr_username;//退货人
	private Date pr_shdate;//退货时间
	private int pr_scbs;

 ...
 <div class="top2_bg">
  ...
  <div class="nav">
   <div class="nav_t">
    ...
    <div class="ly">
     <ul>
     <li  class="tp4_1"><a title="我的订单" href="${pageContext.request.contextPath}/order_qtorders" target="_blank">我的订单</a></li>
      <li class="tp2_1" ><a title="购物车" href="${pageContext.request.contextPath }/shoppingcar_querygwclist" target="_blank">购物车</a></li>
      <li class="tp3_1" style="background:#930807;"><a title="地址管理" href="${pageContext.request.contextPath }/useraddress_qtqueryuseraddress" target="_blank">地址管理</a></li>
      <li class="tp1_1" ><a title="个人中心" href="${pageContext.request.contextPath }/qtuser_queryUserInfo" target="_blank">个人中心</a></li>

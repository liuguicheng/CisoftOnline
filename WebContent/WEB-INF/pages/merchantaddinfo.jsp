...
<script type="text/javascript">
	$(function(){
		$("#parentid").val("${merchantInfo.merchantClass.id}");
		$("#save").click(function() {
			$("#form1").form('submit', {
...
<body class="easyui-layout">	
	<div region="center">
			...
			<div style="height: 330px;">
				...
				<input type="hidden" name="mi_scbs" value="<s:property value="merchantInfo.mi_scbs"/>">
				<input type="hidden" name="mi_starttime" value="<s:property value="merchantInfo.mi_starttime"/>">
				<input type="hidden" name="mi_id" value="<s:property value="merchantInfo.mi_id"/>">
					<table style="margin: 0 auto;">
						...
						<tr>
							<td >商户等级</td>
							<td>
							<input type="hidden" name="merchantClass.id" id="fid" value="<s:property value="merchantInfo.merchantClass.id"/>">
								<select id="parentid" name="d" class="select_d">
									<option value="0">无</option>
									<s:iterator value="#mclass" var="m">
							...
							<td >到期时间</td>
							<td>
							<input name="mi_endtime" type="text" id="txtStartTime" readonly="readonly" value="<s:property value="merchantInfo.mi_endtime"/>" class="easyui-datebox" >
							</td>
						</tr>
						<tr>
							<td></td>

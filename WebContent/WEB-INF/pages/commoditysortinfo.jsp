...
<script type="text/javascript">
	$(function(){		
		...
		$("#save").click(function(){
			$("#form1").form('submit',{
				url:'${pageContext.request.contextPath}/csort_save',
				onSubmit:function(){
	...
	<div region="center">
			...
			<div style="height: 330px;">
				...
				<input type="hidden" name="_parentId" id="fid" value="${_parentId}">
					...
					<tr>
							<td style="width: 20%;text-align: right;">父商品分类</td>
							<td style="text-align: left;padding-left: 20px;">
								<select id="parentid" name="cs_parentid" class="select_d">
						...
						<tr>
							<td style="width: 20%;text-align: right;">商品分类名称</td>
							<td style="text-align: left;padding-left: 20px;">
								<input type="hidden" id="id" name="cs_id" value="${cs_id}">
								<input type="hidden" id="isdelete" name="cs_scbs" value="${cs_scbs}">
								
								<input type="text" id="unitname" name="cs_name" class="txt200" value="${cs_name }" >
						...
						<tr>
							...
							<td style="text-align: left;padding-left: 20px;">
								...
								<input type="text" id="px" name="cs_px" class="txt200" value="${cs_px }">
								<span id="pxid" style="color:red;display:none;">不能为空</span>
							</td>
						</tr>
						<tr>

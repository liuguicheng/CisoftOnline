...
<script type="text/javascript">
	$(function(){		
		$("#save").click(function(){
			$("#form1").form('submit',{
				url:'${pageContext.request.contextPath}/unit_save',
				onSubmit:function(){
			...
			<div style="height: 330px;">
				<form id="form1" method="post">
					<table style="margin: 0 auto;width: 50%;">
						<tr>
							<td style="width: 20%;text-align: right;">单位名称</td>
							<td style="text-align: left;padding-left: 20px;">
								<input type="hidden" id="id" name="id" value="${id}">
								<input type="hidden" id="isdelete" name="isdelete" value="${isdelete}">
								
								<input type="text" id="unitname" name="unitname" style="width: 300px;" value="${unitname }">

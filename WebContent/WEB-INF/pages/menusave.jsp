			...
			<div style="height: 330px;">
				<form id="form1" method="post">
					...
					<table style="margin: 0 auto;width: 50%;">
						...
						<tr>
							<td style="width: 20%;text-align: right;">菜单名称</td>
							<td style="text-align: left;padding-left: 20px;">
								<input type="text" id="menuname" name="menuname" value="${menuname }" class="txt200">
								<span id="menunameid" style="color:red;display:none;">不能为空</span>
							</td>
						</tr>
						<tr>

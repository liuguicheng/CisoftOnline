...
<script type="text/javascript">
	$(function(){
							...
							$('#tree').tree({ 
								...
								onLoadSuccess:function(){
									...
									$.ajax({
										async:false,
										type:"POST",
										url:'${pageContext.request.contextPath}/role_getLimitByRoleid',
										data:"id="+id,
		...
		$("#btn").click(function(){			
			...
			$("#menuid").val(ids);
			$("#form1").form('submit',{
				url:"${pageContext.request.contextPath}/role_savelimit",
				success:function(data){
		...
		location.href="${pageContext.request.contextPath}/role_editView?id="+id; */
			...
			var widoid="123"+id;
			  var iWidth="768"; //弹出窗口的宽度;
		         ...
		         window.open('${pageContext.request.contextPath}/role_editView?id='+id,widoid,'height='+iHeight+',width='+iWidth+',top='+iTop+',left='+iLeft+',toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');
	}
	function add(){
		var widoid="123r";
		  var iWidth="768"; //弹出窗口的宽度;
			 ...
			 var iTop = (window.screen.availHeight-30-iHeight)/2; //获得窗口的垂直位置;
			 var iLeft = (window.screen.availWidth-10-iWidth)/2; //获得窗口的水平位置;
	         window.open('${pageContext.request.contextPath}/pages_roleoperate?id=0',widoid,'height='+iHeight+',width='+iWidth+',top='+iTop+',left='+iLeft+',toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');
}
</script>
</head>

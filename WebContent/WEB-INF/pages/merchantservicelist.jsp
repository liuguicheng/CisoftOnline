...
<script type="text/javascript">
	$(function(){
		$('#grid').treegrid({
			...
			rownumbers:true,
			method:"post",
			url : "${pageContext.request.contextPath}/mserac_getList",
			idField : 'id',
			treeField:'menuname', 
			animate:true,
			toolbar :'#tb',
	...
	function add(){
		...
		window
				.open(
						'${pageContext.request.contextPath}/mserac_addView'
							,
						widoid,
						'height='
								+ iHeight
								...
								+ ',left='
								+ iLeft
								+ ',toolbar=no,mseracbar=no,scrollbars=no,resizable=no,location=no,status=no');
	}
	function edit(id) {
		...
		window
				.open(
						'${pageContext.request.contextPath}/mserac_editView?id='
								+ id,
						widoid,
						'height='
								+ iHeight

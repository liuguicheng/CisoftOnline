...
<script type="text/javascript"> 
					...
					/* toolbar : [
						{
							...
							handler:function(){
								parent.forward('采购收货',"");
								location.href="${pageContext.request.contextPath}/purchaserece_addView";
							}
						}
					], */
					columns : [[
	...
	function edit(id){
		...
		location.href="${pageContext.request.contextPath}/purchaserece_editView?pr_id="+id; */
		var widoid=",'new"+id+"'";
		  var iWidth="1324"; //弹出窗口的宽度;
			 var iHeight="768"; //弹出窗口的高度;
			 var iTop = (window.screen.availHeight-30-iHeight)/2; //获得窗口的垂直位置;
			 var iLeft = (window.screen.availWidth-10-iWidth)/2; //获得窗口的水平位置;
	         window.open('${pageContext.request.contextPath}/purchaserece_editView?pr_id='+id,widoid,'height='+iHeight+',width='+iWidth+',top='+iTop+',left='+iLeft+',toolbar=no,menubar=no,scrollbars=no,resizable=no,location=no,status=no');
	}
	function del(id){

...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/validate/userinfoupdate_validate.js"></script>
					...
					<table style="margin: 0 auto;width: 50%;" class="table">
						<tr>
							...
							<td class="td2">
								...
								<input type="hidden" id="password" name="u_pwd" value="${u_pwd}">
						...
						<tr>
							...
							<td class="td2">
								<input type="text" id="zsname" name="u_zsName" value="${u_zsName }" class="txt200">
								<span  id="zsnameid" style="color:red;display:none;">不能为空</span>
							</td>				
						</tr>
						<tr>

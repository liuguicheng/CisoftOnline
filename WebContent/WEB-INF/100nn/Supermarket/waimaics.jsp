...
<link rel="stylesheet" type="text/css" href="100nn/cj/alert/jquery.prompt.css">
   ...
   <div id="MianRight_z">
      ...
      <div id="MianRight_wz">
       <div class="MianRight_mianTitle_userNav">
                        ...
                        <div class="MianRight_mianTitle_userNavTitle">购物车 <span id="gwcid"></span> 件</div>
...
<table width="100%" border="0" height="74" class="bg222">
  ...
  <tr>
   <td rowspan="7" align="center"><a href="qtcommodity_querycommdityList?commodity=null" target="_blank">暂无选中商品，马上去挑选？</a></td>
  </tr>
</table>
</s:else>
      </div>
...
<!-- 提示框 -->
<script type="text/javascript" src="100nn/cj/alert/jquery.prompt.min.js"></script>

    ...
    <div id="MianRight">
      <% 
       ...
       <input id="idss" type="hidden" value="<%=ids %>"/>
        <div id="MianRight_z" style="margin: 10px 14px 0;">
      <div id="MianRight_wt">用户中心</div>
      <div id="MianRight_wz" style="margin-top:5px;">
       <div class="MianRight_mianTitle_userNav" style="-webkit-box-sizing:inherit;box-sizing:content-box;">
                        ...
                        <div class="MianRight_mianTitle_userNavTitle">地址管理</div>
                ...
                <div class="MianRight_mianTitlesNav">
                	<table class="MianRight_mianTitlesNavBJn" style="border:0; font-weight:bold;" cellspacing="0" cellpadding="0">
                    	<tr style="height:36px;">
                        	<td style="background:#eef4d8; text-align:center;" width="150">姓名</td>
                            <td style="background:#eef4d8; text-align:center;">地址</td>
                            <td style="background:#eef4d8; text-align:center;" width="200">邮编</td>
                            <td style="background:#eef4d8; text-align:center;" width="200">电话</td>
                            <td style="background:#eef4d8; text-align:center;" width="200">是否默认地址</td>
                            <td style="background:#eef4d8; text-align:center;" width="200">操作</td>
                        </tr>
                    </table>
                    <div id="tbs">
                    <table class="MianRight_mianTitlesNavBJn" style="margin-top:10px;" cellspacing="0" cellpadding="0">
                        ...
                        <tr class="odd" id='<s:property value="#u.ua_id"/>'>
                            ...
                            <td style="border-top:#dadada solid 1px; text-align:center; color:#7b7b7b;"><s:property value="#u.ua_address"/></td>
                            ...
                            <td style="border-top:#dadada solid 1px; text-align:center; color:#a2c314;" width="200"><a id="updateuseraddress" onclick="updateuseraddress('<s:property value="#u.ua_id"/>');" href="#" title="" target="_self">修改</a> | <a id="deleteuseraddress" href="#" title="" onclick="deleteuseraddress('<s:property value="#u.ua_id"/>');" target="_self">删除</a></td>
                        </tr>
                        </s:iterator>
                        </s:if>
                        <s:else>
                ...
                <!-- 	<div class="MianRight_mianTitlesNavBJ" style="border-bottom:#bbb7b8 dotted 1px;">新增收货地址</div> -->
                    ...
                    <form action="" id="formids" method="post">
                        ...
                        <div class="MianRight_mianTitlesNavBJn_mian">
                        	<div class="MianRight_mianTitlesNavBJn_mianSpantitle"></div>
                            <div class="MianRight_mianTitlesNavBJn_mianSpangh">
                                <div class="MianRight_mianTitlesNavBJn_mianSpangh_text"><img src="100nn/Supermarket/images/bc_button.jpg" width="73" height="31" onclick="adduseraddresss();" /></div>
                            </div>
                        </div>
                        </form>
                    </div>

...
<head>
 <base href="<%=basePath%>">
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/plugins/websocketInstantMsg/ext4/resources/css/ext-all.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/plugins/websocketInstantMsg/css/websocket.css" />
	<script type="text/javascript" src="${pageContext.request.contextPath }/plugins/websocketInstantMsg/ext4/ext-all-debug.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/plugins/websocketInstantMsg/websocket.js"></script>
	<!-- 即时通讯 -->
...
<body>
	...
	<div class="container-fluid" id="main-container">
		...
		<div id="main-content" class="clearfix">
			...
			<div style="padding-left: 70%;padding-top: 1px;">
				<div style="float: left;margin-top: 3px;"><img src="${pageContext.request.contextPath }/ExpandingBusiness/static/images/loadingi.gif" /> </div>
				<div style="margin-top: 5px;"><h4 class="lighter block red">&nbsp;加载中 ...</h4></div>
			</div>
			</div>

			<div>
				 <iframe name="mainFrame" id="mainFrame" frameborder="0" src="user_tab" style="margin:0 auto;width:100%;height:100%;"></iframe> 
			</div>
	...
	<!-- basic scripts -->
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/ExpandingBusiness/static/js/myjs/menusf.js"></script>
		
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${pageContext.request.contextPath }/ExpandingBusiness/static/js/myjs/index.js"></script>
</body>
</html>

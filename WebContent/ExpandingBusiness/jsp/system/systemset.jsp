...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath }/ExpandingBusiness/static/css/ace-skins.min.css" />
		<script type="text/javascript" src="${pageContext.request.contextPath }/ExpandingBusiness/static/js/jquery-1.7.2.js"></script>
		
		<!-- 上传图片插件 -->
		<link href="${pageContext.request.contextPath }/plugins/uploadify/uploadify.css" rel="stylesheet" type="text/css">
		<script type="text/javascript" src="${pageContext.request.contextPath }/plugins/uploadify/swfobject.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath }/plugins/uploadify/jquery.uploadify.v2.1.4.min.js"></script>
		<!-- 上传图片插件 -->
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/ExpandingBusiness/static/js/myjs/sys.js"></script>	
	...
	<div class="tabbable">
            ...
            <div class="tab-content">
			  <div id="home" class="tab-pane in active">
				<form action="user_saveSys" name="Form" id="Form" method="post">
			  ...
			  <div id="profile" class="tab-pane">
			  	<form action="user_saveSys2" name="Form2" id="Form2" method="post">
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<tr>
						<td style="text-align: center;" colspan="100">
							文字水印配置
			  ...
			  <div id="profile3" class="tab-pane">
			  	<form action="user_saveSys3" name="Form3" id="Form3" method="post">
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<tr>
						<td style="text-align: center;" colspan="100">
							微信接口配置
...
<div id="zhongxin2" class="center" style="display:none"><br/><br/><br/><br/><img src="${pageContext.request.contextPath }/ExpandingBusiness/static/images/jiazai.gif" /><br/><h4 class="lighter block green"></h4></div>
	
		<!-- 引入 -->
		<script type="text/javascript">window.jQuery || document.write("<script src='${pageContext.request.contextPath }/ExpandingBusiness/static/js/jquery-1.9.1.min.js'>\x3C/script>");</script>

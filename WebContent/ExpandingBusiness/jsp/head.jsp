...
<div class="navbar navbar-inverse">
		  <div class="navbar-inner">
		   <div class="container-fluid">
			  <a class="brand"><small><i class="icon-leaf"></i> ${pdinfo.SYSNAME}</small> </a>
			  ...
			  <ul class="nav ace-nav pull-right">
					...
					<li class="green">
						...
						<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Alex's Avatar" class="msg-photo" src="${pageContext.request.contextPath }/ExpandingBusiness/static/avatars/avatar.png" />
									<span class="msg-body">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Susan's Avatar" class="msg-photo" src="${pageContext.request.contextPath }/ExpandingBusiness/static/avatars/avatar3.png" />
									<span class="msg-body">
										<span class="msg-title">
							...
							<li>
								<a href="javascript:alert('预留功能,待开发');">
									<img alt="Bob's Avatar" class="msg-photo" src="${pageContext.request.contextPath }/ExpandingBusiness/static/avatars/avatar4.png" />
									<span class="msg-body">
										<span class="msg-title">
					...
					<li class="light-blue user-profile">
						<a class="user-menu dropdown-toggle" href="javascript:;" data-toggle="dropdown">
							<img alt="FH" src="${pageContext.request.contextPath }/ExpandingBusiness/static/avatars/user.jpg" class="nav-user-photo" />
							<span id="user_info">
							<small>Welcome</small>${session.usersession.u_name }
							</span>
						...
						<ul id="user_menu" class="pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							...
							<li class="divider"></li>
							<li><a href="user_sjlogout"><i class="icon-off"></i> 退出</a></li>
						</ul>
					</li>
			  </ul><!--/.ace-nav-->
		   </div><!--/.container-fluid-->
		...
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="${pageContext.request.contextPath }/ExpandingBusiness/static/js/myjs/head.js"></script>
